...
#define MQ_NOLOCAL_SHARED_SUBSCRIPTION_NO_CLIENTID ((MQError)(MQ_BASE_ERROR_CODE + 2112))
#define MQ_CONSUMER_NO_SUBSCRIPTION_NAME        ((MQError)(MQ_BASE_ERROR_CODE + 2113))
