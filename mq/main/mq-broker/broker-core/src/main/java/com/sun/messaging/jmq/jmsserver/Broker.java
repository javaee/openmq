...
public class Broker implements GlobalErrorHandler, CommBroker {
    ...
    private static boolean NO_CLUSTER = false;
    private static boolean NO_HA = false;
	 ...
	 */
        ...
        if (Globals.getHAEnabled()) {
            if (brokerid == null) {
                logger.log(Logger.ERROR, BrokerResources.E_BID_MUST_BE_SET);
                return (1);
            }
...
//        	Level.parse(args[n]);
    ...
    */
    ...
    public static void main(String args[]) {
        Integer ret = brokerMain(args);
        if (ret != null) {
            System.exit(ret.intValue());
        }
    }

    public static Integer brokerMain(String args[]) {
