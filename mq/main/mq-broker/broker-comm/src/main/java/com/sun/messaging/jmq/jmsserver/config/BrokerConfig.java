...
//        + "imq.log.jmx.output=ALL\n"
     ...
     */
    private static final String JMQ_prop_loc = CommGlobals.JMQ_LIB_HOME + File.separator +
    ...
    public BrokerConfig(String configname, Properties params, boolean resetProp, Properties saveProps) throws BrokerException {
        ...
        logger.log(Logger.DEBUG, BrokerResources.I_JMQ_HOME, CommGlobals.JMQ_HOME);
