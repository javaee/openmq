    ...
    */
    ...
    public void init(String clusterid, MQAddress brokerURL,
        ...
        if (!mqa.equals(brokerURL)) {
            ...
            logger.log(Logger.INFO, BrokerResources.I_UPD_STORED_PORT,
                                    mybrokerid, brokerURL);
                ...
                try {
                    ...
                    if (Globals.getStore().getPartitionModeEnabled()) {
                        ...
                        while (itrp.hasNext()) {
                            ...
                            logger.log(Logger.INFO, "XXXProcess taken over data from store session "+uid);
                            DL.addStorePartition(ps, false);
                            logger.log(Logger.INFO, "XXXProcessed taken over data from store session "+uid);
                        }
                    ...
                    Globals.getDestinationList().remoteCheckTakeoverMsgs(msgs, tracker.getTargetName());
        ...
        if (BrokerStatus.getBrokerInDoubt(newStatus) && 
            ...
            try {
                ...
                watchBroker(brokerid, brokerSession);
                   ...
                   && BrokerStatus.getBrokerIsUp(newStatus)) {
            logger.log(logger.INFO, BrokerResources.I_BROKER_OK, brokerid);
