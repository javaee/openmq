...
public class BrokerLink extends Thread {
    ...
    public synchronized void sendPacket(GPacket gp) throws IOException {
        sendPacket(gp, false, false);
    }

    public synchronized void sendPacket(GPacket gp, boolean close, boolean urgent)
    throws IOException {
    ...
    private static Socket makeSSLSocket(InetAddress host, int port,
