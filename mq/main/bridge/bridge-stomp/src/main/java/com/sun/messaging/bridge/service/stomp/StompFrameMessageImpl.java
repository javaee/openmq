...
public class StompFrameMessageImpl extends StompFrameMessage {
    ...
    protected static final LoggerWrapper loggerWrapper = new LoggerWrapperImpl();
    ...
    static class StompFrameMessageFactoryImpl implements StompFrameMessageFactory { 
        public StompFrameMessage newStompFrameMessage(Command cmd) {
            return new StompFrameMessageImpl(cmd);
        }
    }
    ...
    protected StompFrameMessageImpl(Command cmd) {
        super(cmd, loggerWrapper);
    } 
    ...
    public static StompFrameMessageImpl parseCommand(Buffer buf) throws Exception {
        return (StompFrameMessageImpl)StompFrameMessage.parseCommand(
                new ByteBufferWrapperImpl(buf), loggerWrapper, factory);
    }
