...
public class StompProtocolHandlerImpl extends StompProtocolHandler {
    ...
    private static final LoggerWrapper loggerWrapper = StompFrameMessageImpl.loggerWrapper;

    private static final Version mqversion = new Version();

    private StompBridgeResources sbr = null;

    public StompProtocolHandlerImpl(BridgeContext bc,  Properties jmsprop) {
        super(loggerWrapper);
        sbr = StompServer.getStompBridgeResources();
        stompConnection = new StompConnectionImpl(bc, jmsprop, this);
    }
